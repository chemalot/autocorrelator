...
public class OmegaRunner1_8 extends OERunner
{  OmegaRunner1_8(String jobType, JobExecution parentExec, String execName)
   ...
   {  String cmd = super.getExecutionCommand(paramValues);
      cmd =String.format("%s -in %s -out %s", cmd, parentExec.getOutputFileName()
                                            , getOutputFileName());
      return cmd;
   }
}
